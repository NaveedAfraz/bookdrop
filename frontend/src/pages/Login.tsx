        ...
        <div className="min-h-[85vh] flex items-center justify-center px-6 py-12 mesh-hero grain">
            ...
            <div className="max-w-md w-full bg-card border border-border p-10 md:p-12 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
                ...
                <div className="text-center mb-10 relative z-10">
                    ...
                    <h1 className="text-3xl font-heading italic text-text mb-2">Access Sanctum</h1>
                    <p className="text-subtext italic text-sm">Continue your literary journey.</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-6 relative z-10">
                    ...
                    >
                        {loading ? <Loader2 className="animate-spin" size={18}/> : <>Enter Sanctuary <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform"/></>}
                    </button>
                </form>

                <div className="mt-10 pt-8 border-t border-border text-center relative z-10">
                    <p className="text-subtext text-xs mb-4">New to the verse?</p>
                    <Link to="/register" className="inline-flex items-center gap-2 text-secondary font-bold text-xs uppercase tracking-widest hover:underline group">
                        Initiate Ritual <ArrowRight size={14} className="group-hover:translate-x-1 transition-transform" />
                    </Link>
                </div>

                <div className="mt-8 flex justify-center gap-4 opacity-30 grayscale hover:grayscale-0 transition-all duration-700">
                    <ShieldCheck size={16} />
                    <div className="text-[8px] font-bold uppercase tracking-[0.2em] self-center">End-to-End Encrypted</div>
                </div>
            </div>
        </div>
    );
